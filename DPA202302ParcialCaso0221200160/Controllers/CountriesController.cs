...
namespace DPA202302ParcialCaso0221200160.Controllers
{
    ...
    {
        private readonly ExamenParcialContext _context;

        public CountriesController(ExamenParcialContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Country>> PostCountry(Country country)
        {
          if (_context.Country == null)
          {
              return Problem("Entity set 'ExamenParcialContext.Country'  is null.");
          }
